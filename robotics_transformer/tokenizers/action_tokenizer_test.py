...
class ActionTokenizerTest(tf.test.TestCase):
    ...
    def testDetokenize_int32(self):
        ...
        self.assertSequenceEqual([1, 0], list(
        ...
        self.assertSequenceEqual([0, 1], list(
            action['terminate_episode'].numpy()))
    ...
    def testTokenize_float_at_limits(self):
        ...
        self.assertSequenceEqual(
            [0, vocab_size - 1], list(action_tokens.numpy()))
    ...
    def testTokenizeAndDetokenizeIsEqual(self):
        ...
        for _ in range(n_repeat):
            action = tensorspec_utils.TensorSpecStruct(
                ...
                gripper_closedness_action=np.random.uniform(
                    low=0., high=1.0, size=1),
