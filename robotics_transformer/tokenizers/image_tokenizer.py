...
"""A FiLM Efficientnet contextual image tokenizer used in Robotics Transformer
1."""
from typing import Optional

import tensorflow as tf

from robotics_transformer.film_efficientnet import \
