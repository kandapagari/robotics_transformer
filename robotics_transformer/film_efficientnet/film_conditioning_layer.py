...
class FilmConditioning(tf.keras.layers.Layer):
    ...
    This is intended to be applied after a convolutional layer. It will
    learn a multiplicative and an additive factor to be applied to each
    channel of the convolution's output.
    ...
    def call(self, conv_filters: tf.Tensor, conditioning: tf.Tensor):
        ...
        if len(conv_filters.shape) == 4:
            ...
            projected_cond_mult = projected_cond_mult[:,
